export default {
    ...
    imageGeneration: {
        alias: "Unified model name (optional)",
        maxConcurrency: "Image concurrency (current tab)",
        concurrency: "Limit {{count}}",
        selection: "{{model}} · {{count}} providers",
        noChannel: "Check the selected image providers, models, Base URLs, and API keys",
