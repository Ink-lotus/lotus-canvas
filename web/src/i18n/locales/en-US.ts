export default {
    ...
    common: {
        ...
        mediaActionFailed: "Could not access the local media file",
        upload: "Upload",
    ...
    config: {
        ...
        localStorage: {
            ...
            migration: {
                legacy: "Media to migrate",
                pending: "{{count}} IndexedDB files",
                done: "Migration complete",
                action: "Migrate existing media to desktop library",
                confirmTitle: "Migrate existing media?",
                confirmDescription: "Migrate {{count}} files ({{size}}) to {{path}} one at a time. Each IndexedDB source is removed only after verification.",
                start: "Start migration",
                cancel: "Stop after current file",
                progress: "Migrating {{current}} / {{total}}",
                summary: "{{migrated}} migrated, {{failed}} failed",
                completed: "Migrated {{count}} media files",
                partial: "Migration complete: {{migrated}} succeeded and {{failed}} failed",
                canceled: "Migration stopped; you can resume later",
                failed: "Migration failed",
                noSpace: "Not enough free disk space for the largest file",
            },
        ...
        channels: {
            description: "Choose a protocol for each provider, fetch its models, set an optional unified name, assign capabilities, and customize request scripts.",
            add: "Add provider",
        ...
        preferences: {
            ...
            reversePrompt: "Default reverse prompt",
            reversePromptDescription: "Clicking “Reverse prompt” on an image node uses this text for the task description node.",
            reversePromptPlaceholder: "Enter the default prompt used to infer image prompts.",
        ...
        channelEditor: {
            ...
            maxConcurrencyDescription: "Image tasks share this provider limit, from 1 to 20.",
            models: "Provider models",
            modelDescription: "{{count}} selected; set an optional unified name, capability, and request script for each model.",
            alias: "Unified model name",
            aliasPlaceholder: "Optional; used to group providers",
