export default {
    ...
    version: {
        ...
        restartInstallTitle: "Restart and install the update?",
        restartInstallDescription: "The app will close and install the downloaded update. Save your work before continuing.",
